...
addp=[FSroot ';' ...
    FSroot f 'toolbox' f 'multivariate;' ...
    FSroot f 'toolbox' f 'regression;' ...
    FSroot f 'toolbox' f 'clustering;' ...
    FSroot f 'toolbox' f 'graphics;' ...
    FSroot f 'toolbox' f 'datasets' f 'regression;' ...
    FSroot f 'toolbox' f 'datasets' f 'multivariate;' ...
    FSroot f 'toolbox' f 'datasets' f 'multivariate_regression;' ...
    FSroot f 'toolbox' f 'datasets' f 'clustering;' ...
    FSroot f 'toolbox' f 'combinatorial;' ...
    FSroot f 'utilities;' ...
    FSroot f 'utilities_stat;' ...
    FSroot f 'utilities_help;' ...
    FSroot f 'toolbox' f 'examples;'...
    FSroot f 'toolbox' f 'FSDAdemos' ];
